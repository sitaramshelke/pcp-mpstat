...
from pcp_mpstat import HardInterruptUsageReporter
...
class TestHardInterruptUsageReporter(unittest.TestCase):
    ...
    def test_print_report(self):
        ...
        hard_interrupt_usage.get_percpu_interrupts = Mock(return_value = cpu_interrupts)
        report = HardInterruptUsageReporter(hard_interrupt_usage, printer, options)
